...
public interface WdMethods {
		 ...
		 */
		public void selectDropDownUsingText(WebElement ele, String value) throws InterruptedException ;
		 ...
		 * @throws Exception 
		 */
		public void selectDropDownUsingIndex(WebElement ele, int index) throws Exception ;
